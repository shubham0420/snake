...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("The objective of game is to eat red apple",black,-30)
        message_to_screen("The more apple you eat longer you live",black,10)
...
def gameLoop():
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            message_to_screen("Press C to play again and Q to quit",black,50,size="small")
            pygame.display.update()
...
##                randAppleY = round(random.randrange(0,display_height)/10.0)*10.0
##                snakeLength +=1
